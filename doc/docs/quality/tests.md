...
| `omniwrench-core` | [`StreamDemuxerTest`](file:///home/vortigern/git/omniwrench/omniwrench-core/src/test/java/com/omniwrench/core/StreamDemuxerTest.java) | 4 | `REQ-00088`, `FR-00011`, `FR-00014`, `UC-00001`, `TSK-20260822-007` | Thinking tag parsing, static separation, token streaming state machine, and null safety |
| `omniwrench-core` | [`OpenApiToolSchemaGeneratorTest`](file:///home/vortigern/git/omniwrench/omniwrench-core/src/test/java/com/omniwrench/core/OpenApiToolSchemaGeneratorTest.java) | 4 | `REQ-00095`, `FR-00020`, `FR-00011`, `TSK-20260822-012` | OpenAPI 3.1, Gemini, and Anthropic function calling schema generation, required fields, and context filtering |
| `omniwrench-core` | [`ZeroMockAuditTest`](file:///home/vortigern/git/omniwrench/omniwrench-core/src/test/java/com/omniwrench/quality/ZeroMockAuditTest.java) | 1 | `REQ-00092`, `CS-0055`, `TSK-20260822-013` | Automated reactor-wide static analysis scanning `src/main/java` enforcing zero mock imports and zero mock annotations |
| `omniwrench-tools` | [`AgentEngineTest`](file:///home/vortigern/git/omniwrench/omniwrench-tools/src/test/java/com/omniwrench/tools/AgentEngineTest.java) | 3 | `REQ-00043`, `REQ-00060`, `REQ-00088`, `FR-00014`, `UC-00001`, `TSK-20260822-005`, `TSK-20260822-007` | Agent reasoning loop, `/thinking` toggle commands, prompt processing, and tool dispatching |
...
| `omniwrench-ai` | [`LlamaCppBackendAdapterTest`](file:///home/vortigern/git/omniwrench/omniwrench-ai/src/test/java/com/omniwrench/ai/llamacpp/LlamaCppBackendAdapterTest.java) | 5 | `REQ-00090`, `REQ-00093`, `FR-00011`, `FR-00012`, `UC-00001`, `TSK-20260822-009`, `TSK-20260822-015` | Embedded llama.cpp GGUF local model execution, reactive token streaming (`Flux`), and error boundary |
| `omniwrench-ai` | [`LlamaCppSignalGuardTest`](file:///home/vortigern/git/omniwrench/omniwrench-ai/src/test/java/com/omniwrench/ai/llamacpp/LlamaCppSignalGuardTest.java) | 4 | `REQ-00090`, `REQ-00093`, `TSK-20260822-015` | Signal guard fault containment, NPE/OOM trapping, and structured BackendException translation |
| `omniwrench-ai` | [`LlamaCppNativeBridgeTest`](file:///home/vortigern/git/omniwrench/omniwrench-ai/src/test/java/com/omniwrench/ai/llamacpp/LlamaCppNativeBridgeTest.java) | 2 | `REQ-00090`, `REQ-00093`, `TSK-20260822-015` | In-process model context initialization, tokenization, decoding, sampling, and AutoCloseable memory cleanup |
| `omniwrench-ai` | [`NativeLibraryLoaderTest`](file:///home/vortigern/git/omniwrench/omniwrench-ai/src/test/java/com/omniwrench/ai/llamacpp/NativeLibraryLoaderTest.java) | 3 | `REQ-00090`, `REQ-00093`, `TSK-20260822-015` | Multi-architecture host OS/Arch identification, platform strings, and GPU compute enums |
| `omniwrench-ai` | [`ModelRepositoryAndManagerTest`](file:///home/vortigern/git/omniwrench/omniwrench-ai/src/test/java/com/omniwrench/ai/ModelRepositoryAndManagerTest.java) | 4 | `REQ-00091`, `FR-00011`, `UC-00001`, `TSK-20260822-010` | Model descriptor contracts, Ollama/HuggingFace search, download progress, and local lifecycle removal |
| `omniwrench-ai` | [`ModelManagementOptionalIntegrationTest`](file:///home/vortigern/git/omniwrench/omniwrench-ai/src/test/java/com/omniwrench/ai/model/ModelManagementOptionalIntegrationTest.java) | 6 | `REQ-00091`, `FR-00011`, `FR-00020`, `TSK-20260822-010` | Live search against Ollama Library & HuggingFace Hub, OCI manifest resolution, SHA-256 digest validation, and local discovery |
| `omniwrench-tools` | [`ModelManagementToolTest`](file:///home/vortigern/git/omniwrench/omniwrench-tools/src/test/java/com/omniwrench/tools/ModelManagementToolTest.java) | 4 | `REQ-00060`, `REQ-00091`, `FR-00020`, `TSK-20260822-010` | Model management tool execution actions: list, search, pull, and rm |
| `omniwrench-tools` | [`AdvancedFileOperationsToolTest`](file:///home/vortigern/git/omniwrench/omniwrench-tools/src/test/java/com/omniwrench/tools/AdvancedFileOperationsToolTest.java) | 6 | `REQ-00060`, `REQ-00093`, `REQ-00094`, `FR-00020`, `FR-00021`, `TSK-20260822-011` | Recursive tree exploration, multi-file regex grep, unified patching, line slicing, hex encoding, and async execution |
| `omniwrench-tui` | [`TerminalRendererTest`](file:///home/vortigern/git/omniwrench/omniwrench-tui/src/test/java/com/omniwrench/tui/TerminalRendererTest.java) | 6 | `REQ-00001`, `REQ-00088`, `FR-00001`, `UC-00001`, `TSK-20260822-003`, `TSK-20260822-007` | Cyberpunk ASCII banner, telemetry status bar, thinking boxes, user/agent bubbles, and prompt formatting |
...
| `omniwrench-web` | [`AgentStreamWebSocketHandlerTest`](file:///home/vortigern/git/omniwrench/omniwrench-web/src/test/java/com/omniwrench/web/AgentStreamWebSocketHandlerTest.java) | 1 | `REQ-00050`, `REQ-00052`, `REQ-00088`, `FR-00016`, `UC-00003`, `TSK-20260822-004`, `TSK-20260822-007` | Real-time WebSocket `thought.delta` and `chat.delta` event generation and lifecycle tracking |
...
| `omniwrench-app` | [`TriInterfacePromptE2ETest`](file:///home/vortigern/git/omniwrench/omniwrench-app/src/test/java/com/omniwrench/TriInterfacePromptE2ETest.java) | 1 | `REQ-00089`, `FR-00001`, `FR-00015`, `UC-00001`, `UC-00003`, `UC-00004`, `TSK-20260822-008` | Tri-interface prompt execution parity across CLI (`-p`), interactive TUI engine, and Web REST endpoints with session history sync |

## Summary Metrics
- **Total Test Suites**: 30 classes
- **Total Test Methods**: 96 methods
- **Test Pass Rate**: 100% (90 core suite + 6 optional remote integration tests passing)
