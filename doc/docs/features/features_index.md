...
- **`FR-00047` XTerm-256 TUI Theming Engine**: Four bundled JSON themes with semantic color tokens, live `F6` picker popup, and hot-reload via file watcher (`ADR-0057`).
